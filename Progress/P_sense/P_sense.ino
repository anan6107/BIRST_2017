...
void loop() {
  ...
  // To measure to higher degrees of precision use the following sensor settings: // ADC_1024  //ADC_2048 //ADC_4096
  // Read temperature from the sensor in deg C. This operation takes about 
  temperature_c = sensor.getTemperature(CELSIUS, ADC_512); //temp in deg C
  temperature_f = sensor.getTemperature(FAHRENHEIT, ADC_512); //temp in deg F -> not internal to the sensor
